...
final class MessageFilterExtension: ILMessageFilterExtension {
    ...
    override init() {
        ...
        print("Loaded whitelist contexts: \(self.whitelistContexts)")
    }
    ...
    private func determineAction(for messageBody: String) -> ILMessageFilterAction {
        ...
        print("No blacklisted keywords found or all keywords were in whitelisted contexts, allowing the message")
        return .allow
    }
}
