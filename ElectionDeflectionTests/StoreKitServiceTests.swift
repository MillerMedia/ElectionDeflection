...
final class StoreKitServiceTests: XCTestCase {
    ...
    func testLoadProductsSuccess() async {
        ...
        // We can't easily create Product instances in tests without StoreKitTest session,
        // but we can verify the flow doesn't crash and updates state.
        // Since MockProductFetcher returns empty array by default:
